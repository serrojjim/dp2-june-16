...
<acme:menu-bar code="master.menu.home">
	...
	<acme:menu-option code="master.menu.authenticated" access="isAuthenticated()">
			...
			<acme:menu-suboption code="master.menu.authenticated.update-task" action="/authenticated/task/update"/>
						<acme:menu-suboption code="master.menu.authenticated.create-task" action="/authenticated/task/create"/>
			
			
		</acme:menu-option>
		
		<acme:menu-option code="master.menu.manager" access="isManager()">
			<acme:menu-suboption code="master.menu.manager.list-tasks" action="/manager/task/list"/>
			<acme:menu-suboption code="master.menu.authenticated.update-task" action="/manager/task/update"/>
						<acme:menu-suboption code="master.menu.authenticated.create-task" action="/manager/task/create"/>
